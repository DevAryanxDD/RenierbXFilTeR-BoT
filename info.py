...
URL = "https://moviezxworld-07f35a8f76bd.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://moviezxworld-07f35a8f76bd.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://moviezxworld-07f35a8f76bd.herokuapp.com/".format(FQDN)
else:
    URL = "https://moviezxworld-07f35a8f76bd.herokuapp.com/".format(FQDN)
